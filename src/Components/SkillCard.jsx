...
const SkillCard = ({ skill }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl bg-gray-800 p-4 shadow-md w-28 h-32 hover:shadow-lg hover:shadow-indigo-500/30  transition">
      {IconComponent && (
