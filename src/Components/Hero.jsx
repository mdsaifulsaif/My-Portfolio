...
const Hero = () => {
  return (
    <div className="text-white    py-20 px-4 md:px-20 flex flex-col-reverse md:flex-row items-center justify-between relative overflow-hidden">
      {/* Left Content */}
      <div className="md:w-1/2 text-center md:text-left space-y-6 z-10">
        <h1 className="text-3xl md:text-5xl font-bold leading-tight">
          ...
          <br />
          I’m <span className="text-blue-400">Saiful Saif</span>
          <br />a{" "}
        ...
        <p className="text-gray-300 max-w-md">
          Hi, I’m Saiful – a passionate MERN stack developer. I help brands turn
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            href="#contact"
            className="bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-500 text-white px-6 py-3 rounded-md flex items-center gap-2"
          >
            <MdCall /> Book a Call
          </a>
          <a
      ...
      <div className="md:w-1/2 mb-10 md:mb-0 flex justify-center relative">
        {/* Glowing background */}
        <div className="absolute w-90 h-98 rounded-full bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-500 opacity-30 blur-2xl z-0"></div>
